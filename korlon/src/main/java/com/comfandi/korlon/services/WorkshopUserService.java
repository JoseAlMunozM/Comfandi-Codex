...
import com.comfandi.korlon.repositories.WorkshopUserRepository;
...
public class WorkshopUserService {
    ...
    public void updateAccountId(List<ApiInformationDatabase> users, BillingAccountEntity account) {
        for (ApiInformationDatabase user : users) {
            workshopUserRepository.updateIdAccounts(user.getUserId(), account.getBillingAccountId().longValue(), LocalDate.now());
        }
    }
